package com.spring.mysqltest.exchange.common;
...
public class PagingUtil {
	...
	public static CommonDto setPageUtil(CommonForm commonForm) {
		...
		// 페이지 네이게이션 설정
		pagination += "<div class='pagination'><div class='col text-center'><div class='block-27'><ul>";
		pagination += "<li><a href='javascript:" + functionName + "(\"" + totalFirstPage + "\");' class=\"direction_left01\"><<</a></li>";
		pagination += "<li><a href='javascript:" + functionName + "(" + prePerPage + ");' class=\"direction_left01\"><</a></li>";
		for (int a = viewFirstPage; a <= ViewLastPage; a++) {
			if (a == currentPage) {
				pagination += "<li><a href='javascript:" + functionName + "(\"" + a + "\");' class='onpage'>" + a + "</a></li>";
			} else {
				pagination += "<li><a href='javascript:" + functionName + "(\"" + a + "\");'>" + a + "</a></li>";
			}
		}
		pagination += "<li><a href='javascript:" + functionName + "(" + nextPerPage + ");' class=\"direction_right01\">></a></li>";
		pagination += "<li><a href='javascript:" + functionName + "(" + totalLastPage + ");' class=\"direction_right01\">>></a></li>";
