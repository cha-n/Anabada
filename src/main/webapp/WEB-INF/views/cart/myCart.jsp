...
<script>
   ...
   function check_Quantity(num) { //수량이 공백인지 확인 & 주문금액 변경
      ...
      if($("#quantity"+num).val()=='' || $("#quantity"+num).val()==0) {
         ...
         document.getElementById("result2").innerHTML=resultPrice;
...
<body class="goto-here">
  ...
  <form name="cartForm" method="post" action="${contextPath}/order/deliveryForm">
  	<div class="container">
  		<div class="row">
			           ...
			           <c:otherwise>
			             <c:forEach  var="cart" items="${cartList }" varStatus="num">
			              <tr class="text-center">
			                 ...
			                 <td><div class="img"><img src="${contextPath}/download.do?articleNO=${cart.articleNO}&imageFileName=${cart.imageVO.imageFileName}" id="preview${num.count}" width="90" height="90"></div></td>
			                 ...
			                 <td>
			                    <input type="button" value="삭제" class="btn btn-black px-4 py-2" onclick="deleteItem(${cart.articleNO})">
    		...
    		<div class="row justify-content-end">
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
    					...
    					<p class="d-flex">
    						<span>장바구니 합계</span>
    						<span id="result" style="width:20%;">${resultPrice}</span>원
    					</p>
    					<p class="d-flex">
    						<span>배송료</span>
    						<span style="width:17%;">0</span>원
    					</p>
    					<p class="d-flex">
    						<span>할인</span>
    						<span style="width:17%;">0</span>원
    					...
    					<p class="d-flex total-price">
    						<span>결제 금액</span>
    						<span id="result2" style="width:17%;">${resultPrice}</span>원
    					</p>
    				</div>
    				<p><input type="submit" value="결제" class="btn btn-primary py-3 px-4"></p>
    			</div>
    		</div>
			</div>
			</form>
