...
<script>
	$(document).ready(function() {
		...
		$(".selectDelete_btn").click(function() {
			...
			if (confirm_val) {
				...
				$.ajax({
					url : "${contextPath}/share/deleteMyShareList?user="+ user, //전송
					type : "post",
					data : {
						chbox : checkArr
					},
					success : function(result) {
						if (result == 1) {
							location.href = "${contextPath}/share/myShareList?user="+ user; //전송이 이상없으면 새로고침
						} else {
							alert("삭제 실패");
						}
					}
	...
	function goBoardDetail(boardSeq) {
		location.href = "${contextPath}/share/boardDetail?boardSeq=" + boardSeq+ "&active=mylist";
	}

	function getMyShareList(currentPageNo) {
		...
		$.ajax({
			...
			url : "${contextPath}/share/getMyShareList?user="+user,
	...
	/** 게시판 - 목록 조회  콜백 함수 */
	function getMyShareListCallback(obj) {
...
<!-- 			<div class="sidebar-box ftco-animate">
			<div class="tagcloud">
				...
				<a href="#" class="tag-cloud-link" onclick="getMyShareList()">나눔</a>
			...
			<div class="row">
    			<div class="col-md-12 ftco-animate">
    				<div class="cart-list">
  					...
  					<input type="button" value="나눔" id="shareButton" class="btn btn-primary py-2 px-3" style="background:#9f9f9f;border:0;" onclick="getMyShareList()">
  					</span>
    			  	<br>
  					<br>
    					<table class="table">
