    ...
    function addChat(chatName, chatContent, chatTime, profile) {
			if (profile == "null"){
				$('#chatList').append('<div class="row">' +
						...
						'<img class="image" style="width: 40px; height: 40px;" src="${contextPath}/resources/image/no_profile.png">' +
						'</a>' +
				...
				$('#chatList').append('<div class="row">' +
						...
						'<div class = "media">' +
						'<a class="pull-left" href="#">' +
						'<img class="image" style="width: 40px; height: 40px;" src="${contextPath}/member/download?profile=' + profile + '">' +
						'</a>' +
						'<div class="media-body">' +
						'<h4 class="media-heading">' +
						chatName +
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="portlet portlet-default">
					<div class="portlet-heading" style="background-color : #81ae47; text-align:center">
						...
						<div class="portlet-footer">
							<div class="row" style="height: 90px;">
								...
								<div class="form group col-xs-2">
									<button type="button" class="btn py-3 px-4 btn-primary" onclick="submitFunction();">전송</button>
									<div class="clearfix"></div>
								</div>
							</div>
						</div>
