  	...
  	<div class="container">
  		<div class="row">
			...
			<div>
				...
				<thead>
				<tr class="line1">				
					<th><p style="text-align:center;padding-top:7%; "><img src="${contextPath}/download.do?articleNO=${articleNO}&imageFileName=${article.imageFileName}" id="preview" width="50" height="50" /></p></th>
					<th style="text-align:left;" onclick='javascript:goArticleDetail(${articleNO });' style='cursor:Pointer'>${article.title}</th>
					<%-- <td style="text-align:left;">${article.title}</td> --%>
					</tr>
				</thead>
				<tbody>
  				<tr>
  					 <td colspan="2" style="padding-bttom:5%; "></td>
 				 </tr>
				<tr>
				<td >별점</td>
