		    ...
		    <span style="float:right;">
	    		...
	    		<div class="row">
	    			...
	    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
						...
						<a href="#" onClick="goMyBoardList()">${article.n_name }</a> <ui style="padding-left: 5px;padding-right: 5px;">ㆍ</ui><ui style="padding-right: 10px;">조회수</ui><ui>${article.hits }</ui><ui style="padding-left: 5px;padding-right: 5px;">ㆍ</ui><ui style="padding-right: 10px;">작성일시</ui><ui>${article.writeDate}</ui>
