...
<script type="text/javascript">
	...
	function fn_addFile(){
		cnt=cnt+1;
		html="";
		html+="<tr><td width=0 height=200 align=center bgcolor=#44C7FE><span id='imageText"+cnt+"'> </td>";
			...
			<div class="comment-form-wrap pt-5">
				<form name="frmArticle" method="post" action="${contextPath}" class="p-5 bg-light" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="button" value="품목 찾기" class="btn btn-white py-3 px-5" onclick="_popUp()">
						 	...
						 	<c:forEach var="item" items="${imageFileList}" varStatus="status" >
								<tr id="img${status.count}">
									<c:if test="${status.count eq 1}">
										<td width="0" height="200" align="center" bgcolor="#44C7FE"><span id="imageText${status.count }"></span></td>
									</c:if>
					...
					<br>
					<div class="form-group">
						<input type="button" value="이미지 추가" onClick="fn_addFile()" class="btn btn-white py-3 px-5"/>
					</div>
					<br>
