...
<script>
	$(document).ready(function() {
		...
		$(".selectDelete_btn").click(function() {
			...
			if (confirm_val) {
				...
				$.ajax({
					url : "${contextPath}/board/deleteMyBoardList?user="+ user, //전송
					type : "post",
					data : {
						chbox : checkArr
					},
					success : function(result) {
						if (result == 1) {
							location.href = "${contextPath}/board/myBoardList?user="+ user; //전송이 이상없으면 새로고침
						} else {
							alert("삭제 실패");
						}
					}
	...
	function getMyBoardList(currentPageNo) {
		...
		$.ajax({
			...
			url : "${contextPath}/board/getMyBoardList?user="+user,
	...
	/** 게시판 - 목록 조회  콜백 함수 */
	function getMyBoardListCallback(obj) {
...
<!-- 			<div class="sidebar-box ftco-animate">
			<div class="tagcloud">
				...
				<a href="#" class="tag-cloud-link" onclick="getMyBoardList()">판매</a>
			...
			<div class="row">
    			<div class="col-md-12 ftco-animate">
    				<div class="cart-list">
     				<span>
     				<input type="button" value="판매" id="boardButton" class="btn btn-primary py-2 px-3" style="background:#82ae46;border:0;" onclick="getMyBoardList()">
