...
<script type="text/javascript">
	...
	function goBoardWrite(log){
		if(log==true)
			location.href = "${contextPath}/board/boardWrite";
		else {
			alert("로그인이 필요합니다.");
			location.href = "${contextPath}/member/loginForm?action=/board/boardWrite";
		}
	}
	...
	function getBoardList(currentPageNo){
		...
		$.ajax({	
			...
			url		:"${contextPath}/board/getBoardList?"+"searchType="+$("select option:selected").val()+ "&keyword="+encodeURIComponent($('#keywordInput').val()),
