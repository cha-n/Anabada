    ...
    <!-- END nav -->
   	...
   	<section class="ftco-section"> 
		<div class="container">
            ...
            <form id="boardForm" name="boardForm" action="/board/updateBoard" class="p-5 bg-light" enctype="multipart/form-data" method="post" onsubmit="return false;">
            	<input type="hidden" id="imageCnt" value=1 >
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="location" value="${member.address }" disabled><br>
					...
					<div class="form-group">
						...
						<input id="item" name="item" value="" class="form-control" readonly><br>
