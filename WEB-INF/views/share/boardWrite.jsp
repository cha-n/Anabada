	...
	function insertBoard() {
		...
		if (yn) {
			...
			$("#boardForm").ajaxForm({
				...
				url : "${contextPath}/share/insertBoard",
   	...
   	<section class="ftco-section"> 
		<div class="container">
			<div class="comment-form-wrap pt-5">				
					<form id="boardForm" name="boardForm" action="/share/insertBoard" class="p-5 bg-light" enctype="multipart/form-data" method="post" onsubmit="return false;">
