	...
	function insertBoard() {
		...
		if (yn) {
			...
			$("#boardForm").ajaxForm({
				...
				url : "${contextPath}/exchange/insertBoard",
  	...
  	<section class="ftco-section"> 
		<div class="container">
			<div class="comment-form-wrap pt-5">				
					<form id="boardForm" name="boardForm" action="/exchange/insertBoard" class="p-5 bg-light" enctype="multipart/form-data" method="post" onsubmit="return false;">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="items" name="items" value=""  disabled><br>
